...
## Deriving Vocabulary 
Have saved vocal.txt for both SARS and pseudomonas in data folder

If you are running our code on a new dataset, you need to compute the vocabulary from your dataset.
To perform tree decomposition over a set of molecules, run
```
python ../fast_jtnn/mol_tree.py < ../data/sars/train.txt
```
...
Have saved the pkl files in mineral container
```
python preprocess.py --train ../data/sars/train.txt --split 100 --jobs 16
mkdir sars-processed
mv tensor* sars-processed
```
...
```
mkdir vae_model/
python vae_train.py --train sars-processed --vocab ../data/sars/vocab.txt --save_dir vae_model/
```
Default Options:
